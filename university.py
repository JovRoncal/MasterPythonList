...
for i in range(len(restaurant_ids)):
    print(f"ID: {restaurant_ids[i]}, Name: {restaurant_names[i]}, Location: {restaurant_locations[i]}, Cuisine: {restaurant_cuisine_types[i]}, Established: {restaurant_established_years[i]}, Website/Contact: {restaurant_websites_or_contacts[i]}")