...
for i in range(len(book_ids)):
    print(f"ID: {book_ids[i]}, Title: {book_titles[i]}, Author: {book_authors[i]}, Genre: {book_genres[i]}, Year: {book_published_years[i]}, ISBN: {book_isbns[i]}, Stock: {book_stocks[i]}, Price: ${book_prices[i]:.2f}")